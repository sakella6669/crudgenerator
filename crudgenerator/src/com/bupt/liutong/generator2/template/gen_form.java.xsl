...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="table">
		<root>
package <xsl:value-of select="parameters/parameter[@id='basePackage']/@value"/>.<xsl:value-of select="@package"/>.form.<xsl:value-of select="string:firstLetterLower(parameters/parameter[@id='genPrefixUpper']/@value)"/>;
...
public class <xsl:value-of select="parameters/parameter[@id='genPrefixUpper']/@value"/><xsl:value-of select="@clazz"/>Form extends BaseForm {
